		...
		m_workerThread = std::thread([this]()
			{
				while (m_workerRunning) {
					...
					if (!m_goofishHttpSystem->refresh_token(cookie, m_configModel->deviceId, refreshToken, accessToken))
					{
